                ...
                <AuthProvider>
                    <RiskZonesProvider>
                        <UserProvider>
                            ...
                            <Route
                                path="/riskzones/:riskZoneId/criticalspots/:criticalSpotId/sensornodes/:sensorNodeId/variables"
                                exact
                            >
                                <Grid container direction="column">
                                    <Grid item xs>
                            ...
                            <Route
                                path="/riskzones/:riskZoneId/criticalspots/:criticalSpotId/sensornodes"
                                exact
                            >
                                <Grid container direction="column">
                                    <Grid item xs>
                            ...
                            <Route
                                path="/riskzones/:riskZoneId/criticalspots"
                                exact
                            >
                                <Grid container direction="column">
                                    <Grid item xs>
